...
/**
 * A class that handles all keyboard input. It is utilized in the GamePanel class. 
 */
public class KeyboardHandler implements KeyListener {
    ...
    /**
     *  Method for checking whether a key is pressed down. Called in GameLoop's update().
     *  
     * 
    ...
    public static boolean isKeyDown(int key) {
        if (keyboardRecord[key] && pressDelay <= 0) {
            pressDelay = 32; // Press Delay Assures that key input isn't astronomically fast.
